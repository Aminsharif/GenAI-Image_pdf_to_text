...
st.set_page_config(layout="wide", page_title="OCR App", page_icon="📄")
st.title("Mistral OCR Application")
st.markdown("<h3 style color: white;'>Built by <a href='https://github.com/Aminsharif'>Amin Sharif </a></h3>", unsafe_allow_html=True)
with st.expander("Expand Me"):
    st.markdown("""
    This application allows us to extract information from pdf/image based on Mistral OCR. Built by Amin Sharif.
    """)
